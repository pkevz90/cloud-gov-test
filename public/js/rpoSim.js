                ...
                case 'start-join':
                    ...
                    responseJoin.players.forEach(player => {
                        Object.assign(this.players[player.name], {
                            ...
                            burns: event.target.id === 'start-join' ? player.burns : math.zeros(responseJoin.scenarioConditions.nBurns, 2)._data,
                    ...
                    Object.assign(this.scenario_data, {
                        ...
                        server: event.target.id === 'start-join' ? true : false,
                        gameId: responseJoin._id,
                        player: $('#team-select').val()
                    });
                    if (event.target.id === 'start-join') {
                        setTimeout(this.startGame, 500);
                    }
                    else {
